<template>
    <div class="sop">
        <div class="sopList" v-loading='loading'>
            <div class="sopItem cursor1 sb mg" v-for="(item,i) in sopList" :key="i" @click="stepDetail(item)">
                <div class="al">
        ...
        getsopList () {
            ...
            sopList(data).then(res => {
                ...
                if (res.data.rtnCode == 200) {
                    this.sopList = res.data.data.pageT
                } else {
                    this.sopList = []
                }
            }).catch(e => {
