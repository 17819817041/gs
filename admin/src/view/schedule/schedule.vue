                            ...
                            <div class="appointment_details_child noBar">
                                ...
                                @click="toConfirm(item.booking.bookingId)">
                                    ...
                                    <div class="appointment_details_name user_b">
                                        <div style="padding-bottom:2px;" class="size13 user_b">{{item.booking.userName}}</div>
                                        <div class="size12 al">
...
<script>
import { allBooking } from "@/axios/request.js"
    ...
    methods: {
        ...
        getBooking () {
            ...
            if ((this.totalRecordsCount == this.booking.length) && this.totalRecordsCount !=0 ) {
                ...
                this.$store.commit("setUser",{ key: "loading6", value: true })
