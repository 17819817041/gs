<template>
    <div class="Supplier">
        ...
        <div class="flexEnd mg" style="width: 97%;">
            <div class="add cursor" @click="dialogVisible = true">Add new supplier</div>
        </div>
...
export default {
    data () {
        return {
            ...
            arr:[
                {ID: 1,Name: 'Tom',Email:'12346@qq.com',Action: 'Update',active:true},
                {ID: 2,Name: 'Yota',Email:'asdkk@gmail.com',Action: 'Update',active:true},
            ],
            ruleForm: {
                email: '',
                name: ''
