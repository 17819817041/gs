<template>
    <div class="AddStore" id="AddStore" v-loading='loading'>
		...
		<div class="AdvertisingOperation_back mg al">
            <img class="cursor" style="padding: 0 15px;" src="@/assets/img/back_arrow.png" alt="" @click="goBack">店鋪管理
        </div>
		<div class="noBar" style="height: calc(100% - 11px);overflow-y: auto;overflow-x:hidden;padding-bottom: 30px;">
			<div class="content mg">
				...
				<div style="height: calc(100% - 27px)">
					...
					<el-form :model="ruleForm" :label-position="labelPosition" :rules="rules" ref="ruleForm" label-width="135px" class="demo-ruleForm">
						...
						<el-form-item label="店鋪描述" prop="message" class="bcolor">
							<div class="al">
								<div class="al textarea content_down">
						...
						<el-form-item label="店鋪展示圖片" prop="imageList1" class="bcolor">
							...
							<div class="content_down1" style='font-size: 12px;line-height: 15px;margin-top: 5px;'>
				...
				<div class="detailPlan boxs theme" v-show="submit">
					...
					:label-width="$i18n.locale == 'zh-CN'? '125px': '135px'" class="demo-ruleForm">
						...
						<el-form-item label="廣告媒體內容" prop="imageList" class="bcolor">
							...
							<div class="content_down1" style='font-size: 12px; line-height: 15px;'>媒體內容時長限制5分鐘.</div>
						</el-form-item>
					</el-form>
				</div>
...
import { updateShop, getShopDetailsById, getuploadtoken } from "@/axios/request.js"
export default {
    data() {
        return {
			streetObj: '',
		...
		getShopDetailsById () {
			...
			getShopDetailsById(data).then(res => {
				...
				if (res.data.rtnCode == 200) {
					...
					this.changeArea(res.data.data.addressParentId)
			...
			if (boo && boo2) {
				...
				this.ruleForm2.imageList.forEach((item,i) => {
					arr.push({
						...
						"shopGuangGaoId": this.ruleForm.street,
